  ...
  */
  ...
  client.loadCommand = (commandName) => {
    try {
      ...
      client.logger.log(`Loading Command: ${props.help.name}. 👌 Yeeeet`);
      if (props.init) {
        props.init(client);
      }
  ...
  client.unloadCommand = async (commandName) => {
    ...
    if (!command) return `The command \`${commandName}\` doesn't seem to exist, learn what a command is and be a noob`;
